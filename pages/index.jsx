    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/home/mywebscom/public_html"><a style={{ color: "blue" }}>Home - /home/mywebscom/public_html</a></Link></li>
<li><Link href="/post"><a style={{ color: "blue" }}>Post - /post</a></Link></li>
          </ul>
